...
import com.Emazon.Stock.adapters.utilities.BrandAdapterConstants;
...
public class BrandAdapter implements IBrandPersistencePort {
    ...
    public PagedResult<Brand> getPagedBrands(Integer page, Integer size, boolean ascending) {
        Sort sort = ascending ? Sort.by(BrandAdapterConstants.NAME_FIELD).ascending()
                : Sort.by(BrandAdapterConstants.NAME_FIELD).descending();
        ...
        return new PagedResult<>(brands, brandPage.getNumber(), brandPage.getSize(),
